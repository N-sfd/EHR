...
public interface ProblemListMapper {
    ProblemListDto toDto(ProblemList entity);
    
    @Mapping(target = "id", ignore = true)
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    ProblemList toEntity(ProblemListDto dto);
    
    @Mapping(target = "id", ignore = true)
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    void updateEntityFromDto(ProblemListDto dto, @MappingTarget ProblemList entity);
}
