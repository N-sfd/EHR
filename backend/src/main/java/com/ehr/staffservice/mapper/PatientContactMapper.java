...
import com.ehr.staffservice.dto.PatientContactDto;
...
public interface PatientContactMapper {
    ...
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
    void updateEntityFromDto(PatientContactDto dto, @MappingTarget PatientContact entity);
}
