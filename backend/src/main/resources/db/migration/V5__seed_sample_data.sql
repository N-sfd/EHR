...
-- Sample Coverages
INSERT INTO coverages (patient_id, payer, member_id, group_number, start_date, end_date, eligibility_status, copay, deductible, is_primary) VALUES
(1, 'Blue Cross Blue Shield', 'BC123456789', 'GRP001', '2024-01-01', '2024-12-31', 'ACTIVE', 25.00, 500.00, TRUE),
(2, 'Aetna', 'AET987654321', 'GRP002', '2024-01-01', '2024-12-31', 'ACTIVE', 30.00, 750.00, TRUE),
(3, 'Cigna', 'CIG555666777', 'GRP003', '2023-01-01', '2023-12-31', 'EXPIRED', 20.00, 1000.00, TRUE)
ON CONFLICT DO NOTHING;
...
-- Sample Appointments
INSERT INTO appointments (patient_id, provider_id, department_id, visit_type_id, start_date_time, duration_mins, status, reason) VALUES
(1, 1, 1, 2, '2026-01-10 10:00:00', 30, 'SCHEDULED', 'Follow-up for hypertension'),
(2, 2, 2, 1, '2026-01-10 14:00:00', 60, 'SCHEDULED', 'New patient consultation'),
(3, 1, 1, 2, '2026-01-11 09:30:00', 30, 'SCHEDULED', 'Cardiac follow-up')
ON CONFLICT DO NOTHING;
